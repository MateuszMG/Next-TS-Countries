...
export type SummaryCountryFragment = { __typename?: 'Country', code: string, name: string, emoji: string, languages: Array<{ __typename?: 'Language', name?: string | null }> };
...
export type GetCountryQuery = { __typename?: 'Query', country?: { __typename?: 'Country', code: string, name: string, emoji: string, languages: Array<{ __typename?: 'Language', name?: string | null }> } | null };

export const SummaryCountryFragmentDoc = gql`
